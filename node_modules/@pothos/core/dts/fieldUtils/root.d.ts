...
export default class RootFieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends BaseFieldUtil<Types, ParentShape, Kind> {
    ...
    ]>): import("..").FieldRef<ShapeFromTypeParam<Types, ["Boolean"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<ShapeFromTypeParam<Types, ["Float"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<ShapeFromTypeParam<Types, ["ID"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<ShapeFromTypeParam<Types, ["Int"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<ShapeFromTypeParam<Types, ["String"], Nullable>, Kind>;
    /**
     * create a new field for the current type
     * @param {PothosSchemaTypes.FieldOptions} options - options for this field
     */
    field<Args extends InputFieldMap, Type extends TypeParam<Types>, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<Type> = Types['DefaultFieldNullability']>(options: FieldOptionsFromKind<Types, ParentShape, Type, Nullable, Args, Kind, ResolveShape, ResolveReturnShape>): import("..").FieldRef<ShapeFromTypeParam<Types, Type, Nullable>, Kind>;
